    ...
    private static void puzzle() {
        ...
        draw.each { drawNum ->
            ...
            bingoBoards.removeAll { board ->
                ...
                isCurrentBoardToBeRemoved
            }
        }
    }


    /* the code will print all the boards in sequence of their winning order */
